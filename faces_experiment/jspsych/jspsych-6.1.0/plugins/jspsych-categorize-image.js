...
jsPsych.plugins['categorize-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (info.key == 75){
      display_element.innerHTML = "<p><u>How do you know them:</u> <input style='font-size: 18px; line-height: 1.6em;' input type='text' id='jspsych-categorize-image-correct_text' class='jspsych-categorize-image-corret_text' src='" +trial.correct_text+"'></p>"
    } 
